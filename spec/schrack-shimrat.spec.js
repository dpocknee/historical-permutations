...
const { schrackShimrat } = require("../index");

describe("Schrack-Shimrat (1962)", () => {
  describe("5 Elements", () => {
    const startArray = [1, 2, 3, 4, 5];
    const testArrays = schrackShimrat(5);
  ...
  describe("4 Elements", () => {
    ...
    const testArrays = schrackShimrat(4);
  ...
  describe("3 Elements", () => {
    ...
    const testArrays = schrackShimrat(3);
